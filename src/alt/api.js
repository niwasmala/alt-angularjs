            ...
            $provide.factory('httpInterceptor', ['$log', '$q', '$window', function ($log, $q, $window) {
                return {
                    request: function (config) {
                        ...
                        // config timeout
                        config.timeout = alt.timeout || 10000;
                ...
                return {
                    ...
                    connect: function (url2, data, setting) {
                        ...
                        var deferred = $q.defer(),
                            ...
                            params = {
                                headers: {
                                    'Content-Type': setting.ismultipart ? 'multipart/form-data' : (setting.contenttype ? setting.contenttype : 'application/x-www-form-urlencoded')
                                },
