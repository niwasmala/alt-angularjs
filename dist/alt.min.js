...
alt.loader.store()}):alt.loader.store(),alt.loader.validation=function(){return"undefined"!=typeof alt.modules.validation?alt.modules.validation:(alt.validate=!0,alt.validation={required:function(t){return 0!==t&&(t=(t||"")+""),""!==t&&"undefined"!=typeof t},regex:function(t,e){return t=(t||"")+"",e.test(t)},email:function(t){return this.regex(t,/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i)},username:function(t){return t+="",t.toLowerCase().replace(/[^a-z0-9._-]/,"")},number:function(t){return this.regex(t,/^[0-9]+\.?[0-9]*?$/i)},integer:function(t){return this.regex(t,/^[0-9]*$/i)},equals:function(t,e){return t===e},notequals:function(t,e){return t!==e},lessthan:function(t,e){return e>t},lessequalthan:function(t,e){return e>=t},greaterthan:function(t,e){return t>e},greaterequalthan:function(t,e){return t>=e},between:function(t,e,n){return t>=e&&n>=t},date:function(t){return t+="",8==t.length&&moment(t,"YYYYMMDD").isValid()},month:function(t){return t+="",6==t.length&&moment(t,"YYYYMM").isValid()},year:function(t){return t+="",4==t.length&&moment(t,"YYYY").isValid()},time:function(t){return t+="",4==t.length&&moment(t,"HHmm").isValid()}},alt.modules.validation=angular.module("alt-validation",[]).factory("$validate",["$log","$injector",function(t,e){var n=function(t){return t="undefined"!=typeof t?t:"undefined"!=typeof alt.validate?alt.validate:!0,{rules:[],messages:[],rule:function(t,e){return this.rules.push(t),this.messages.push(e),this},validate:function(){for(var e=!0,n=[],o=0;o<this.rules.length;o++)this.rules[o]||(e=!1,n.push(this.messages[o]));return{res:t?e:!0,message:n}},check:function(){var t=this.validate(),n=e.get("$alert");if(!t.res&&n)for(var o=0;o<t.message.length;o++)n.add(t.message[o],n.danger);return t.res}}};for(var o in alt.validation)alt.validation.hasOwnProperty(o)&&(n[o]=alt.validation[o]);return n}]),void alt.module("alt-validation",alt.modules.route))},"undefined"!=typeof define?define([],function(){alt.loader.validation()}):alt.loader.validation();